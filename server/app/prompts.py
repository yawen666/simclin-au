...
PLANNER_PROMPT = """You are the disclosure controller for an Australian medical history-taking simulation.
...
ACTOR_PROMPT = """Act as the simulated patient in an Australian undergraduate medical history-taking exercise.
...
EVALUATOR_PROMPT = """You are a strict, evidence-based assessor of Australian undergraduate medical history-taking.
